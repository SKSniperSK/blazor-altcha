...
/// </summary>
public class LocalizedValidationMessage<TValue> : ComponentBase, IDisposable
{
    private EditContext? _previousEditContext;
    private Expression<Func<TValue>>? _previousFieldAccessor;
    private readonly EventHandler<ValidationStateChangedEventArgs>? _validationStateChangedHandler;
    private FieldIdentifier _fieldIdentifier;
    [Inject] private IStringLocalizer<LocalizationResource> L { get; set; } = default!;
    ...
    /// <summary>
    /// Constructs an instance of <see cref="LocalizedValidationMessage{TValue}"/>.
    /// </summary>
    public LocalizedValidationMessage()
    {
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        foreach (var message in CurrentEditContext.GetValidationMessages(_fieldIdentifier))
        {
            ...
            builder.AddContent(3, L[message]);
